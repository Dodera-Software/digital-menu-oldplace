...
const CafeMenu = () => {
  ...
  return menuItems.length > 0 ? (
    ...
    >
                ...
                <div className="p-5 md:p-6 flex flex-col h-full">
                  <div className="flex items-start justify-between gap-3 mb-2">
                    <div className="flex-1">
                      <h3
                        className={`text-lg md:text-xl font-serif mb-1 ${
                  ...
                  >
                    {item.description}
                    <br />
                    <span className="text-2xl">{item.price} AFN</span>
                  </p>
      ...
      >
        <div
          className={`max-w-6xl mx-auto px-4 py-8 text-center text-sm font-light ${
            darkMode ? "text-amber-200/60" : "text-amber-700/60"
          }`}
        >
          <p>
            Open daily from {cafeDetails?.openingTime?.slice(1, 2)} AM to{" "}
            {cafeDetails?.closingTime?.slice(1, 2)} PM
          </p>
          <p className="mt-2">{cafeDetails?.address}</p>
